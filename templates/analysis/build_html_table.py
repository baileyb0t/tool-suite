...
# https://github.com/sbi-rviot/ph_table/blob/master/pretty_html_table/pretty_html_table.py
# Since that package doesn't seem to allow all rows to be the same color,
# or at least is broken so that color args do not result in the example layouts in the README,
# this version forks to address that.
